...
const SPECS = {
  dimensoes: "16,5 × 7,5 × 1,5 cm (A × L × P)",
  material: "Polirresina com acabamento dourado",
  base: "Polirresina em tom natural",
  peso: "Aprox. 180 g",
};

const Lupa = ({ slug: slugProp }: { slug?: string } = {}) => {
  ...
  if (!product || product.category !== "objeto") {
  ...
  // Galeria — 1 foto real + lifestyle fictícios
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div className="lg:pt-2">
            ...
            <div className="flex items-center gap-2 mb-6 text-[0.7rem] uppercase tracking-[0.2em] text-terracotta">
              ...
              Peça de curadoria · Despacho em até 3 dias úteis
            </div>
        ...
        <div className="grid md:grid-cols-5 items-stretch">
          <div className="md:col-span-3 order-2 md:order-1 px-5 md:px-16 lg:px-24 py-16 md:py-24 flex flex-col justify-center">
            ...
            <div className="space-y-3 text-[0.95rem] text-ink/85 mb-10">
              <p><span className="font-semibold text-ink">Material do aro:</span> {SPECS.material}</p>
              <p><span className="font-semibold text-ink">Material do cabo:</span> {SPECS.base}</p>
              <p><span className="font-semibold text-ink">Acabamento:</span> Aro em tom dourado fosco</p>
              ...
              <p><span className="font-semibold text-ink">Uso:</span> Adorno decorativo · não é lupa óptica de precisão</p>
              <p><span className="font-semibold text-ink">Origem:</span> Peça de curadoria da coleção Sol da Manhã</p>
            </div>
            <h3 className="font-display text-xl md:text-2xl text-terracotta mb-3">
              Descrição adicional
            </h3>
            <p className="text-ink/75 leading-relaxed text-[0.95rem]">
              A lupa decorativa é uma daquelas peças pequenas que mudam o ar de um ambiente.
              Toda em polirresina, com aro finalizado em dourado fosco e cabo em tom natural,
              remete a bibliotecas antigas e ateliers de arquitetos. Descansa naturalmente sobre
              livros, consoles ou aparadores — presença discreta, com pegada quase de arquivo
              pessoal.
            </p>
          </div>
      ...
      <section className="bg-secondary">
        <div className="grid md:grid-cols-5 items-stretch">
          <div className="md:col-span-3 bg-cream">
            <img
              src={hero3}
              alt="Lupa decorativa em composição de ambiente"
              loading="lazy"
              className="w-full h-full object-cover min-h-[60vh] md:min-h-full"
            />
          </div>
          <div className="md:col-span-2 px-5 md:px-16 lg:px-20 py-16 md:py-24 flex flex-col justify-center">
            ...
            <p className="text-ink/75 leading-relaxed text-[0.95rem] mb-8">
              Limpe apenas com pano macio seco ou levemente úmido. Evite produtos abrasivos,
              álcool e solventes — podem retirar o acabamento dourado do aro. Não exponha a
              peça diretamente ao sol por longos períodos e mantenha longe de fontes de calor,
              já que a polirresina pode sofrer variações com temperatura extrema.
            </p>
            ...
            <p className="text-ink/75 leading-relaxed text-[0.95rem] mb-8">
              Ideal como adorno sobre livros, consoles, escrivaninhas, aparadores e estantes.
              Combina bem com objetos em tons neutros, madeira, vidro e metais dourados —
              conversa direto com o restante da coleção Sol da Manhã.
            </p>
            ...
            <p className="text-ink/75 leading-relaxed text-[0.95rem]">
              Um detalhe pequeno que muda a leitura do ambiente. Uma peça de curadoria
              pensada para quem gosta de composições cheias de camadas — sem excesso,
              sem óbvio.
            </p>
          </div>
        </div>
      ...
      <section className="bg-ink text-cream py-20 md:py-28 px-5 md:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-cream/75 mb-8 max-w-lg mx-auto">
            Peça de curadoria em polirresina com acabamento dourado. Despacho em até 3 dias úteis para todo o Brasil.
          </p>
          <button
            onClick={scrollToBuy}
